...
# Major finance YouTubers — search for their recent uploads
_FINANCE_YOUTUBER_QUERIES = [
    "Graham Stephan latest",
    "Meet Kevin stock market",
    "Andrei Jikh investing",
    "Coin Bureau crypto",
    "Patrick Boyle finance",
    "The Plain Bagel investing",
    "How Money Works latest",
    "Economics Explained latest",
    "Real Vision finance",
    "Coldfusion tech business",
]
...
class YouTubeScraper(BaseScraper):
    ...
    async def scrape(self) -> list[dict[str, Any]]:
        ...
        all_queries = _SEARCH_QUERIES + _FINANCE_YOUTUBER_QUERIES
...
_MOCK_VIDEOS = [
    ...
    # Earnings call style videos
    ("LIVE: Tesla Q4 2025 Earnings Call — Revenue Beats, Margins Disappoint", "CNBC", 2_400_000),
    ("Apple Earnings Call Q4 2025 Full Breakdown — Services Revenue Explodes", "The Plain Bagel", 780_000),
    ("NVIDIA Earnings Call Highlights — Data Center Revenue Up 200% YoY", "Patrick Boyle", 1_300_000),
    ("Microsoft Q4 Earnings: Azure Growth Slowing? Full Analysis", "Meet Kevin", 950_000),
    ("Amazon Earnings Reaction — AWS Margins CRUSHED Expectations", "Graham Stephan", 1_100_000),
    # Corporate events
    ("MASSIVE Layoffs at Google — 12,000 Jobs Cut, Here's Why", "How Money Works", 2_800_000),
    ("FDA Approves New Alzheimer's Drug — Eli Lilly Stock Soars", "The Motley Fool", 420_000),
    ("Disney Acquires EA for $40B — Gaming Industry Shockwave", "Coldfusion", 1_900_000),
    ("Product Recall Alert: Samsung Batteries Exploding Again", "CNBC", 670_000),
    ("Stock Market Today: S&P 500 Hits New All-Time High", "Bloomberg TV", 1_600_000),
]

_ALL_QUERIES = _SEARCH_QUERIES + _FINANCE_YOUTUBER_QUERIES
    ...
    async def scrape(self) -> list[dict[str, Any]]:
        ...
        for _ in range(count):
            ...
            posts.append(self._make_post(
                ...
                raw_metadata={
                    "channel": channel,
                    "search_query": random.choice(_ALL_QUERIES),
