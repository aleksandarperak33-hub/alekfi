...
class Settings(BaseSettings):
    ...
    reddit_user_agent: str = "AlekFi/1.0"
    youtube_api_key: str = ""
    ...
    gatekeeper_batch_size: int = 75
    brain_batch_size: int = 30
    brain_synthesis_interval: int = 2  # minutes between synthesis runs
    brain_entity_batch_size: int = 10  # posts per LLM entity extraction call
    brain_parallel_batches: int = 3  # concurrent entity extraction batches
    brain_entity_confidence_threshold: float = 0.5
    learning_interval: int = 21600  # seconds between learning engine runs (6h)
    log_level: str = "INFO"
